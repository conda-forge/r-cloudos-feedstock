...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-cloudos-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14303&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-cloudos-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-cloudos` can be installed with:

```
conda install r-cloudos
```

It is possible to list all of the versions of `r-cloudos` available on your platform with:
